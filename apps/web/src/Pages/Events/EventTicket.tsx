            ...
            >
                ...
                <button
                    ...
                    className={cn(
                        ...
                        "bg-muted/80 hover:bg-border-strong backdrop-blur-sm",
                        "transition-all duration-200",
                        isDownloading && "opacity-50 cursor-not-allowed"
                    )}
                    aria-label="Download ticket as image"
                >
                    <Download className={cn("size-4 text-foreground/80", isDownloading && "animate-pulse")} />
                </button>

                {/* Hero Section - Ticket and Status at top */}
                <div className="relative bg-linear-to-br from-card via-secondary to-primary/10 px-6 pt-6 pb-8 rounded-t-3xl overflow-hidden">
                    {/* Lime glow blobs */}
                    <div className="absolute -top-10 -right-10 w-56 h-56 bg-primary/6 rounded-full blur-3xl pointer-events-none" />
                    <div className="absolute -bottom-6 -left-6 w-40 h-40 bg-primary/4 rounded-full blur-2xl pointer-events-none" />
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-5 relative z-10 mb-4">
                        {[
                            ...
                            <div key={label}>
                                <p className="text-[9px] text-muted-foreground/70 uppercase tracking-[0.18em] mb-1.5 flex items-center gap-1.5">
                                    {icon}{label}
                                </p>
