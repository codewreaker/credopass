// ============================================================================
// FILE: services/core/src/analytics/seed.ts
// Deterministic PRNG so the fabricated analytics are stable: the same
// scope + range always returns the same believable numbers (no flicker on
// re-fetch, and demos are reproducible). Pure — no Hono, no DB — so this whole
// folder can be lifted into a standalone service later.
// ============================================================================
